namespace UCEvents_WebAPI.DataAccess
{
    ...
    public partial class EventTable : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Title = c.String(nullable: false, maxLength: 254, unicode: false),
                        Location = c.String(nullable: false, maxLength: 300, unicode: false),
        ...
        {
            DropIndex("dbo.TodoItem", new[] { "CreatedAt" });
